...
export type ConfirmActionProps = HeadlessConfirmActionDialogProps & {
  onHide: () => void;
};

export interface HeadlessConfirmActionDialogProps extends ModalDialogProps {
  onSave: () => Kefir.Observable<any>;
...
export class ConfirmActionDialog extends Component<ConfirmActionProps, State> {
  static defaultProps = {
  ...
  render() {
    return (
      <Modal show={true} className="save-as-dataset-modal" onHide={this.props.onHide}>
        ...
        <Modal.Body>{React.createElement(HeadlessConfirmActionDialog, this.props)}</Modal.Body>
      </Modal>
    );
  }
}

export class HeadlessConfirmActionDialog extends Component<HeadlessConfirmActionDialogProps, State> {
  static defaultProps = {
    placeholder: 'Name of the set',
  };

  constructor(props: HeadlessConfirmActionDialogProps, context) {
    super(props, context);
    this.state = {
